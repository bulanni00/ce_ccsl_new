...
import 'package:ce_ccsl_new/Utils/httpLogin.dart';
...
class _LoginPageState extends State<LoginPage>
  ...
  _getUserPassword() async {
    ...
    Http().postLogin(
        url: 'http://tms.cambodianexpress.com/login',
        data: {'username': username, 'password': password}).then((val) {
